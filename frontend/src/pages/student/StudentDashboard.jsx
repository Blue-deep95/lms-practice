      ...
      <Card sx={{ border: '1px solid #e2e8f0', borderRadius: 4 }}>
        <CardContent sx={{ p: 6 }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
            Welcome to your learning portal! Here you can track your courses, view progress, and access learning materials.
          </Typography>
          <Box sx={{ p: 4, bgcolor: '#f8fafc', borderRadius: 3, border: '1px dashed #cbd5e1', textAlign: 'center' }}>
            <Typography variant="body2" color="text.secondary">
              Dummy Student Dashboard Content (Nothing here yet)
            </Typography>
          </Box>
        </CardContent>
      </Card>
