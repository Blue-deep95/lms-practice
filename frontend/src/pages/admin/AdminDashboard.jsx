...
export default function AdminDashboard() {
  ...
  const menuItems = [
    { text: 'Overview', path: '/dashboard/admin', icon: <DashboardIcon />, exact: true },
    { text: 'Trainers', path: '/dashboard/admin/trainers', icon: <PeopleIcon /> },
    { text: 'Students', path: '/dashboard/admin/students', icon: <SchoolIcon /> },
    { text: 'Courses', path: '/dashboard/admin/courses', icon: <BookIcon /> },
  ];
